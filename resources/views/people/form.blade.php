...
@section('content')
    ...
    <section id="contact" class="section-bg  py-5">
        ...
        <div class="container py-5">
            ...
            <form action="/people/search/post/{{$type}}" method="POST" name="add_report" class="m-5"
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="inputName"
                                   placeholder="{{ __('messages.Name Of Person') }}" name="name" required>
                        ...
                        <div class="form-group {{ $errors->has('age') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control" id="inputAge"
                                   placeholder="{{ __('messages.Age Of Person') }}" min=1 max=90 name="age" required>
                            <span id="NumberErr">
                ...
                <strong>{{ $errors->first('gender') }}</strong>
                        ...
                        <div class="form-group {{ $errors->has('height') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control" id="inputHeight"
                                   placeholder="{{ __('messages.height Of Person In CM ex:125') }}" min=1 max=250
                ...
                <strong>{{ $errors->first('height') }}</strong>
                        ...
                        <div class="form-group  {{ $errors->has('weight') ? ' has-error' : '' }}">
                            ...
                            <input type="number" class="form-control" id="inputWeight"
                                   placeholder="{{ __('messages.Weight Of Person In KG') }}" min=5 max=100 name="weight"
                                   required>
                ...
                <strong>{{ $errors->first('weight') }}</strong>
                        ...
                        <div class="form-group {{ $errors->has('special_mark') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="inputspecial_mark"
                                   placeholder="{{ __('messages.Special Mark Of Person') }}" name="special_mark"
                                   required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group {{ $errors->has('location') ? ' has-error' : '' }}">
                            ...
                            <input type="text" class="form-control" id="inputlocation" name="location"
                                   placeholder="{{ __('messages.Last Location Of Person') }}" required>
