...
Route::get('/people/search', 'reportController@index')->name("people.home")->middleware(increaseView::class);
Route::get('/people/details/{report}', 'reportController@showReportDetails')->middleware(increaseView::class);

Route::get('/filter/{request}', 'reportController@doSearchingQuery')->middleware(increaseClick::class);
...
Route::group(['middleware' => ['auth', 'verified', 'is-ban']], function () {
    ...
    Route::get('/people/image', 'UploadfileController@index')->middleware(increaseView::class);
    ...
    Route::get('/addvalueadmin', 'AttributeController@create')->middleware('role:Admin');
    Route::post('/addvalueadmin/store', 'AttributeController@store')->middleware('role:Admin');
