                ...
                <div class="row">
                    <div class="col-md-6 text-center">
                        ...
                        <div class="row mt-3 ml-2 justify-content-center">
                            ...
                            <div class="fb-share-button ml-2"
                                 data-href="http://127.0.0.1:8000/people/details/{{$item->id}}" data-layout="button"
                    ...
                    <div class="col-md-6">
                        <div class="details">
                            ...
                            <div class="row ">
                                <button id="lostButton" type="button" class="btn" data-toggle="modal"
                                        data-target="#myModal">
                                                ...
                                                <form action="/sendEmailItem/{{$item->id}}" method="POST" class="form">
                                                    ...
                                                    <div class="form-group">
                                                        <textarea class="form-control" name="description"
                                                                  ...
                                                                  placeholder="Write Description To Founder To Know Your Are They Real Owner Of Item"></textarea>
                                                    </div>
                                                    <button type="submit" class="btn"
                                                            id="lostButton">{{ __('messages.Send Description To Report Owner') }}</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
