                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input id="special_mark" name="special_mark" type="text"
                                                   class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="eye_color" name="eye_color" required="">
                                                <option value="black"
                                                    {{ $report->eye_color === "black" ? "selected" : " " }}>Black
                                                </option>
                                                <option value="brown"
                                                    {{ $report->eye_color === "brown" ? "selected" : " " }}>Brown
                                                </option>
                                                <option value="green"
                                                    {{ $report->eye_color === "green" ? "selected" : " " }}>Green
                                                </option>
                                                <option
                                                    value="grey" {{ $report->eye_color === "grey" ? "selected" : " " }}>
                                                    Grey
                                                </option>
                                                <option
                                                    value="blue" {{ $report->eye_color === "blue" ? "selected" : " " }}>
                                                    Blue
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="hair_color" name="hair_color">
                                                <option value="black"
                                                    {{ $report->hair_color === "black" ? "selected" : " " }}>Black
                                                </option>
                                                <option value="brown"
                                                    {{ $report->hair_color === "brown" ? "selected" : " " }}>Brown
                                                </option>
                                                <option value="white"
                                                    {{ $report->hair_color === "white" ? "selected" : " " }}>White
                                                </option>
                                                <option value="grey"
                                                    {{ $report->hair_color === "grey" ? "selected" : " " }}>grey
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="last_seen_on" name="last_seen_on"
                                                    required="">
                                                <option value="Saturday"
                                                    {{ $report->last_seen_on === "Saturday" ? "selected" : " " }}>
                                                    Saturday
                                                </option>
                                                <option value="Sunday"
                                                ...
                                                <option value="Wednesday"
                                                    {{ $report->last_seen_on === "Wednesday" ? "selected" : " " }}>
                                                    Wednesday
                                                </option>
                                                <option value="Thursday"
                                                    {{ $report->last_seen_on === "Thursday" ? "selected" : " " }}>
                                                    Thursday
                                                </option>
                                                <option value="Friday"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input id="last_seen_at" name="last_seen_at" type="time"
                                                   class="form-control"
