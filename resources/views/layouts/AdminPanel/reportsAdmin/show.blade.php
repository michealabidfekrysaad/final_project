      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-3" style="height:250px">
            <img style="height:250px" src="http://loseall.s3.us-east-2.amazonaws.com/{{$report->image}}" />
          </div>
          <div class="col-md-9 p-4">
            ...
            <h4> style:- <span>{{$report->hair_color}}</span> hair and <span>{{$report->eye_color}}</span> eye .
            </h4><br>
            <h4>
