    ...
    <div class="container mt-2  pt-5">
        <div class="card pt-2">
            ...
            <ul class="nav nav-tabs pt-3" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="peopleReport-tab" data-toggle="tab" href="#peopleReport" role="tab" aria-controls="profile" aria-selected="false">{{ __('messages.Your People Reports') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="itemReport-tab" data-toggle="tab" href="#itemReport" role="tab" aria-controls="profile" aria-selected="false">{{ __('messages.Your Items Reports') }}</a>
                </li>
            </ul>
            <div class="card-body">
                <div class="tab-content profile-tab" id="myTabContent">
                    ...
                    <div class="tab-pane fade bg-white" id="peopleReport" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container">
                            <div class="row">
                    ...
                    <div class="tab-pane fade bg-white" id="itemReport" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 pb-3">
                                        <div class="hotel text-center">
                                            <a href="/showReportItem/{{$item->id}}">
                                                <div class="hotel-img">
                                                    <img style="width:348px;height:348px" src="http://loseall.s3.us-east-2.amazonaws.com/{{$item->image}}" alt="Img Of Person" class="img-fluid">
                                                </div>
                                                @if(app()->getLocale()=='ar')
                                            ...
                                            <div class="row justify-content-center">
                                                <a class="btn btn-primary mr-2" href="/item/edit/user/{{$item->id}}">{{ __('messages.Update Report') }}</a>
