    ...
    <div class="row justify-content-center">
       <div class="col-md-6 col-sm-10 text-center">
        ...
        <img id="blah" src="http://placehold.it/300" alt="your image" width="300px" height="300px"/>
            ...
            @endif
                    <span class="text-muted mt-2 d-block">{{ __('messages.Plz Make Sure Image is jpg, jpeg, png') }}</span>
                    <input type="submit" name="upload" class="btn btn-primary mt-3" value="{{ __('messages.Search By Image') }}" >
